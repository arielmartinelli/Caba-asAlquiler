...
export default function CabinDetailPage() {
 ...
 <p className="text-slate-600 text-sm font-semibold">Cargando cabaña...</p>
 </div>
 );
 }
 ...
 <p className="text-slate-600 text-sm">No pudimos encontrar la información de esta cabaña.</p>
 ...
 <Link
 href="/"
 className="inline-flex items-center gap-2 text-xs font-bold text-slate-700 hover:text-rose-500 transition-colors"
 >
 ...
 <span className="px-3.5 py-1 rounded-full text-xs font-extrabold text-slate-900 bg-slate-100 border border-slate-200 ">
 ★ 4.98 • 28 evaluaciones
 </span>
 <span className="px-3.5 py-1 rounded-full text-xs font-extrabold text-emerald-700 bg-emerald-50 border border-emerald-200 flex items-center gap-1">
 ...
 <div className="p-4 rounded-2xl bg-slate-50 border border-slate-200 flex items-center justify-between text-xs font-bold text-slate-800 ">
 <div className="flex items-center gap-2">
 <Users className="w-4 h-4 text-rose-500" />
 <span>Capacidad máxima para {cabin.capacity} huéspedes</span>
 </div>
 <span className="text-emerald-600 font-extrabold">100% Equipado</span>
 </div>
 ...
 <span className="text-xs text-slate-500 ml-1 font-semibold">/ noche</span>
 </div>
 ...
 className="w-full py-3 px-4 rounded-full text-xs font-bold text-slate-800 bg-slate-100 hover:bg-slate-200 border border-slate-300 flex items-center justify-center gap-2 transition-all"
 >
