    ...
    <div className="bg-white dark:bg-[#151c28] rounded-3xl overflow-hidden flex flex-col h-full border border-slate-200 dark:border-slate-800 shadow-md hover:shadow-2xl transition-all duration-300 group">
      ...
      <div className="relative h-64 w-full overflow-hidden bg-slate-100 dark:bg-slate-800">
        ...
        <div className="absolute top-4 left-4">
          <span className="px-3.5 py-1.5 rounded-full text-xs font-extrabold text-slate-950 dark:text-white bg-white/95 dark:bg-slate-900/95 backdrop-blur-md shadow-md border border-slate-200/80 dark:border-slate-800 flex items-center gap-1.5">
      ...
      <div className="p-6 flex-1 flex flex-col justify-between space-y-4">
        <div className="space-y-2">
          <h3 className="text-xl font-extrabold text-slate-950 dark:text-white group-hover:text-rose-500 transition-colors leading-snug">
            {cabin.name}
          </h3>
        ...
        <div className="space-y-4 pt-3 border-t border-slate-200/80 dark:border-slate-800/80">
          <div className="flex flex-wrap gap-1.5">
            {cabin.amenities.slice(0, 3).map((amenity, idx) => (
              <span
                key={idx}
                className="text-[11px] bg-slate-100 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 px-2.5 py-1 rounded-md text-slate-900 dark:text-slate-200 font-semibold flex items-center gap-1"
              >
