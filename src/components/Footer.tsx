...
export default function Footer() {
 return (
 <footer className="bg-white border-t border-slate-200 pt-16 pb-12 text-slate-600 text-xs transition-colors duration-300">
 ...
 {/* Cabins Links */}
 <div>
 <h4 className="text-xs font-bold text-slate-900 mb-4 uppercase tracking-wider">Cabañas</h4>
 ...
 {/* Contact Details */}
 <div>
 <h4 className="text-xs font-bold text-slate-900 mb-4 uppercase tracking-wider">Contacto Directo</h4>
 <ul className="space-y-2.5">
 ...
 {/* Guarantee */}
 <div>
 <h4 className="text-xs font-bold text-slate-900 mb-4 uppercase tracking-wider">Garantía de Reserva</h4>
 ...
 <div className="border-t border-slate-200 mt-12 pt-6 flex flex-col sm:flex-row items-center justify-between text-slate-500 text-xs">
