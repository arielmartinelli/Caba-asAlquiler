...
import { Trees, MapPin, UserCheck, Menu, X, PhoneCall, Search, Sun, Moon } from 'lucide-react';
...
export default function Navbar() {
  ...
  return (
    <header className="sticky top-0 z-50 bg-white/95 dark:bg-[#0c1017]/95 backdrop-blur-lg border-b border-slate-200 dark:border-slate-800 shadow-sm transition-colors duration-300">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-20">
          ...
          <Link href="/" className="flex items-center gap-3 group">
            ...
            <div>
              <span className="text-xl font-extrabold tracking-tight text-slate-950 dark:text-white block leading-tight">
          ...
          <div className="hidden md:flex items-center gap-2 airbnb-search-pill px-5 py-2.5 text-xs font-semibold text-slate-800 dark:text-slate-200">
          ...
          <div className="md:hidden flex items-center gap-2">
            ...
            <button
              ...
              className="p-2 rounded-full text-slate-800 dark:text-slate-200 hover:bg-slate-100 dark:hover:bg-slate-800 border border-slate-200 dark:border-slate-700"
            >
      ...
      {mobileMenuOpen && (
        <div className="md:hidden bg-white dark:bg-[#0c1017] border-t border-slate-200 dark:border-slate-800 px-6 pt-4 pb-6 space-y-4 shadow-xl">
          <Link
            ...
            className="block text-base font-bold text-slate-950 dark:text-white hover:text-rose-500"
          >
            Inicio & Cabañas
          </Link>
          <a
          ...
          <Link
            href="/admin/login"
            onClick={() => setMobileMenuOpen(false)}
            className="block text-center py-2.5 rounded-full text-xs font-bold text-slate-800 dark:text-slate-200 border border-slate-300 dark:border-slate-700"
          >
