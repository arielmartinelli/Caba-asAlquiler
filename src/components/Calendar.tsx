...
export default function Calendar({
 ...
 if (baseCurrency === 'USD') {
 return `${(priceUSD * nights).toLocaleString('en-US')} USD`;
 }
 ...
 blocked
 ? 'bg-slate-100 text-slate-400 line-through cursor-not-allowed border border-slate-200/60 '
 ...
 : 'hover:bg-slate-100 text-slate-900 hover:scale-105 border border-transparent font-semibold'
 }`}
 ...
 {/* Weekday headers */}
 <div className="grid grid-cols-7 gap-1 text-center text-xs font-extrabold text-slate-700 uppercase tracking-wider">
 <span>Lu</span>
 <span>Ma</span>
 <span>Mi</span>
 <span>Ju</span>
 ...
 {/* Legend */}
 <div className="flex flex-wrap items-center justify-between text-xs text-slate-700 font-semibold pt-4 border-t border-slate-200 gap-2">
 <div className="flex items-center gap-1.5">
 ...
 <div className="text-[11px] text-rose-700 font-extrabold uppercase tracking-wider">Fechas Seleccionadas</div>
 ...
 <span className="text-rose-500 text-xs font-semibold animate-pulse">(Elegí salida)</span>
 )}
 </div>
 </div>
 ...
 <div className="text-xs text-slate-700 font-bold">{nightsCount} Noche(s)</div>
