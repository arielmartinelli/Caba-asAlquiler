...
export default function InteractiveMap({
 ...
 <div>
 <div className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-rose-50 border border-rose-200 text-rose-600 text-xs font-extrabold uppercase tracking-wider mb-2">
 <MapPin className="w-3.5 h-3.5" /> Ubicación Exacta
 </div>
 <h3 className="text-2xl font-extrabold text-slate-900 ">{cabinName}</h3>
 <p className="text-xs text-slate-600 flex items-center gap-1.5 mt-1 font-semibold">
 ...
 <div className="absolute top-4 left-4 bg-white/95 backdrop-blur-md px-4 py-2 rounded-full border border-slate-200 text-xs font-extrabold text-slate-900 shadow-md flex items-center gap-2">
 ...
 <span className="text-xs font-extrabold text-slate-900 ">{pt.name}</span>
 </div>
 <span className="text-[11px] font-extrabold text-slate-800 bg-white px-2.5 py-1 rounded-full border border-slate-200 shrink-0 shadow-2xs">
 {pt.distance}
 </span>
 </div>
 ))}
